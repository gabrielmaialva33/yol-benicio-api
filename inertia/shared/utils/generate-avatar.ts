...
export const generateAvatar = () => {
  return `https://avataaars.io/?avatarStyle=Circle&topType=${faker.helpers.arrayElement(
    ...
    accessoriesType
  )}&hairColor=${faker.helpers.arrayElement(hairColor)}&facialHairType=${faker.helpers.arrayElement(
    facialHairType
  )}&clotheType=${faker.helpers.arrayElement(clotheType)}&eyeType=${faker.helpers.arrayElement(
    eyeType
  )}&eyebrowType=${faker.helpers.arrayElement(eyebrowType)}&mouthType=${faker.helpers.arrayElement(
    mouthType

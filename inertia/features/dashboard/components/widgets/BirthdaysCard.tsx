...
export function BirthdaysCard() {
  ...
  return (
    <Card>
      ...
      <p className="text-sm text-gray-500 mb-4">Colegas que fazem aniversário este mês</p>
      <CardContent className="space-y-4">
        {birthdays.slice(0, 2).map((user) => (
          <div className="flex items-center space-x-3" key={user.email}>
            ...
            <button className="p-1 text-gray-400 hover:text-gray-600 cursor-pointer" type="button">

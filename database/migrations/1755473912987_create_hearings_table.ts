...
export default class extends BaseSchema {
  ...
  async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.enum('type', ['audiencia', 'prazo_judicial', 'prazo_extrajudicial', 'prazo_fatal']).notNullable()
      ...
      table.integer('assignee_id').unsigned().nullable().defaultTo(null).references('id').inTable('users').onDelete('SET NULL')

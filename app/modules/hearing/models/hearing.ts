...
// import Folder from '#modules/folder/folder'

export default class Hearing extends BaseModel {
  ...
  @column()
  declare type: 'audiencia' | 'prazo_judicial' | 'prazo_extrajudicial' | 'prazo_fatal'
